...
import io.github.tenhonomedegaz.underwaterplacement.base.ModForgeHooks;
...
public class MarineAnvilMenu extends ItemCombinerMenu {
    ...
    public MarineAnvilMenu(int p_39005_, Inventory p_39006_) {
        this(p_39005_, p_39006_, ContainerLevelAccess.NULL);
    }

    public MarineAnvilMenu(int p_39008_, Inventory p_39009_, ContainerLevelAccess p_39010_) {
    ...
    protected void onTake(Player p_150474_, ItemStack p_150475_) {
        ...
        float breakChance = net.minecraftforge.common.ForgeHooks.onAnvilRepair(p_150474_, p_150475_, MarineAnvilMenu.this.inputSlots.getItem(0), MarineAnvilMenu.this.inputSlots.getItem(1));
    ...
    public void createResult() {
        ...
        if (itemstack.isEmpty()) {
            ...
            if (!ModForgeHooks.onMarineAnvilChange(this, itemstack, itemstack2, resultSlots, itemName, j, this.player)) return;
