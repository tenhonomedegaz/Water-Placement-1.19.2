...
public class MarineBrewingStandMenu extends AbstractContainerMenu {
    ...
    private final Container marinebrewingStand;
    private final ContainerData brewingStandData;
    private final Slot ingredientSlot;

    public MarineBrewingStandMenu(int p_39090_, Inventory p_39091_) {
        this(p_39090_, p_39091_, new SimpleContainer(5), new SimpleContainerData(2));
    }

    public MarineBrewingStandMenu(int p_39093_, Inventory p_39094_, Container p_39095_, ContainerData p_39096_) {
        super(MenuType.BREWING_STAND, p_39093_);
        checkContainerSize(p_39095_, 5);
        checkContainerDataCount(p_39096_, 2);
        this.marinebrewingStand = p_39095_;
        this.brewingStandData = p_39096_;
        this.addSlot(new MarineBrewingStandMenu.PotionSlot(p_39095_, 0, 56, 51));
        this.addSlot(new MarineBrewingStandMenu.PotionSlot(p_39095_, 1, 79, 58));
        this.addSlot(new MarineBrewingStandMenu.PotionSlot(p_39095_, 2, 102, 51));
        this.ingredientSlot = this.addSlot(new MarineBrewingStandMenu.IngredientsSlot(p_39095_, 3, 79, 17));
        this.addSlot(new MarineBrewingStandMenu.FuelSlot(p_39095_, 4, 17, 17));
    ...
    public boolean stillValid(Player p_39098_) {
        return this.marinebrewingStand.stillValid(p_39098_);
    }
    ...
    public ItemStack quickMoveStack(Player p_39100_, int p_39101_) {
        ...
        if (slot != null && slot.hasItem()) {
            ...
            if ((p_39101_ < 0 || p_39101_ > 2) && p_39101_ != 3 && p_39101_ != 4) {
                if (MarineBrewingStandMenu.FuelSlot.mayPlaceItem(itemstack)) {
                ...
                } else if (MarineBrewingStandMenu.PotionSlot.mayPlaceItem(itemstack)) {
