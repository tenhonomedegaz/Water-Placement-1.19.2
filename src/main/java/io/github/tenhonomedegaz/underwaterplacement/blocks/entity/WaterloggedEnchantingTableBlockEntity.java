...
public class WaterloggedEnchantingTableBlockEntity extends BlockEntity implements Nameable {
    public int time;
    public float flip;
    public float oFlip;
    public float flipT;
    ...
    public WaterloggedEnchantingTableBlockEntity(BlockPos pos, BlockState blockState) {
        super(ModBlockEntities.MARINE_ENCHANTING_TABLE.get(), pos, blockState);
    }
    ...
    public static void bookAnimationTick(Level p_155504_, BlockPos p_155505_, BlockState p_155506_, WaterloggedEnchantingTableBlockEntity p_155507_) {
